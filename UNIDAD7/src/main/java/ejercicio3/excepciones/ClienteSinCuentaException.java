...
public class ClienteSinCuentaException extends BancoException {
    public ClienteSinCuentaException(){
        
    }
    public ClienteSinCuentaException(String mensaje) {
        super(mensaje);
    }
    ...
    public static final String EXCEPCION_SINCUENTA = "Error al insertar usuario:  El cliente no ha abierto una cuenta";
    //public static final String EXCEPCION_SINCUENTA = "Error al insertar usuario: ";
    @Override
